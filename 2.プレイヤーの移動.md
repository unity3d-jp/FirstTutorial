...
![コンポーネントの機能について](img/ComponentFunction.png)
...
![コンポーネント追加](img/コンポーネント追加.gif)

追加したらゲームを再生して下さい。
物理演算の機能が追加された事で、Playerオブジェクトが落下する事が確認出来ます。

![Rigidbodyを追加](img/Rigidbodyを追加.gif)
...
![PlayeControllerコンポーネント追加](img/PlayeControllerコンポーネント追加.gif)
...
![Scriptフォルダへ格納](img/Scriptフォルダへ格納.png)
...
![スクリプトを編集](img/EditScript.png)
![monodevelop](img/monodevelop.png)
...
![PlayerControllerの挙動１](img/PlayerController_v1.gif)
...
![PlayerControllerの挙動２](img/PlayerController_v2.gif)
...
![PlayerControllerコンポーネント](img/PlayerControllerコンポーネント.png)
