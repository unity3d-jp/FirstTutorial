...
![PlaneのDuplicate](img/PlaneのDuplicate.png)
...
![Transformの設定](img/Transformの設定.png)
...
![Materialの作成](img/Materialの作成.png)
...
![GroundをMaterialで塗る](img/GroundをMaterialで塗る.png)
...
![WallMaterialの設定](img/WallMaterialの設定.png)
...
![回転したWallの位置](img/回転したWallの位置.png)

Cube3を複製しCube4を作成、位置は以下のように調整します。

	Position(x:9.5, y:0.5, z:-0.5)

![Wall配置完了](img/Wall配置完了.png)
...
![Staticフラグ設定](img/Staticフラグ設定.png)
![ChangeStaticFlags](img/ChangeStaticFlags.png)
